...
var LockSVG = (props) => /* @__PURE__ */ React3.createElement(
  "svg",
  {
  ...
  /* @__PURE__ */ React3.createElement("path", { d: "M240-80q-33 0-56.5-23.5T160-160v-400q0-33 23.5-56.5T240-640h40v-80q0-83 58.5-141.5T480-920q83 0 141.5 58.5T680-720v80h40q33 0 56.5 23.5T800-560v400q0 33-23.5 56.5T720-80H240Zm0-80h480v-400H240v400Zm240-120q33 0 56.5-23.5T560-360q0-33-23.5-56.5T480-440q-33 0-56.5 23.5T400-360q0 33 23.5 56.5T480-280ZM360-640h240v-80q0-50-35-85t-85-35q-50 0-85 35t-35 85v80ZM240-160v-400 400Z" })
);
...
var CoreServer = class {
  ...
  element(flags) {
    ...
    return /* @__PURE__ */ import_react2.default.createElement("div", { id: this.hostname + "_coreelm" }, /* @__PURE__ */ import_react2.default.createElement("div", { style: {
      "width": "350px",
      "height": height,
    ...
    } }, LockSVG_default({}), /* @__PURE__ */ import_react2.default.createElement("span", null, "Requires ", this.requiredHackingSkill, " hacking level! (", Math.round(player.skills.hacking / this.requiredHackingSkill * 100), "%)"))), /* @__PURE__ */ import_react2.default.createElement("div", { style: {
      "width": "350px",
      "height": height,
      ...
      "padding": "4px",
      "margin": "4px"
    } }, /* @__PURE__ */ import_react2.default.createElement("span", { style: { margin: "8px", fontSize: "24px" } }, this.hostname), /* @__PURE__ */ import_react2.default.createElement("div", { style: {
      position: "relative",
      fontSize: "10px"
    } }, /* @__PURE__ */ import_react2.default.createElement("div", { style: {
      top: "0",
      ...
      marginTop: "-32px",
      textAlign: "right"
    } }, "Tasks: ", Object.keys(this.tasks).length, /* @__PURE__ */ import_react2.default.createElement("br", null), "Security: ", xound(this.hackDifficulty, 2), "/", this.minDifficulty)), renderRam ? Bar("#DD3D48", `${xound(this.ramAvailable, 2)}/${xound(this.unallocatedRam, 2)}/${this.maxRam} GB Ram`, [
      { color: "#4288EF", value: this.unallocatedRam / this.maxRam },
      { color: "#9AE6CB", value: this.ramUsed / this.maxRam }
    ]) : /* @__PURE__ */ import_react2.default.createElement(import_react2.default.Fragment, null), renderMoney ? Bar("#DD3D48", `$${xound(this.moneyAvailable, 2)}/$${this.moneyMax}`, [
...
var StrawberryIconSVGComponent = (props) => /* @__PURE__ */ React5.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: 54,
...
// servers/home/core/gui.tsx
var CoreComponent = class extends import_react3.Component {
  gui;
  constructor() {
    super({});
    this.setState({
  ...
  createHeader() {
    ...
    return /* @__PURE__ */ import_react3.default.createElement("div", { style: {
      ...
      flexWrap: "wrap",
      alignItems: "center"
    } }, /* @__PURE__ */ import_react3.default.createElement("span", null, StrawberrySVG_default({ style: {
      ...
      overflow: "hidden",
      whiteSpace: "nowrap"
    } }, "I have this really cool header i don't know what to put here.")), /* @__PURE__ */ import_react3.default.createElement("div", { style: {
      position: "relative",
      width: "100%",
      height: "4px",
      background: "white"
  ...
  renderContent() {
    return /* @__PURE__ */ import_react3.default.createElement("div", null, this.createHeader(), /* @__PURE__ */ import_react3.default.createElement("div", { style: {
      paddingTop: "64px",
      marginLeft: "16px",
      marginRight: "16px"
    } }, /* @__PURE__ */ import_react3.default.createElement("div", { style: {
      ...
      justifyContent: "center",
      width: "100%"
    } }, "Servers"), /* @__PURE__ */ import_react3.default.createElement("div", { style: {
      padding: "16px",
      display: "flex",
      flexDirection: "row",
      flexWrap: "wrap",
  ...
  renderOverview() {
    return /* @__PURE__ */ import_react3.default.createElement("div", null, "Overview... ", this.gui.rootContainer.offsetWidth);
  }
  render() {
    if (!this.state || !this.state.initialized) {
      return /* @__PURE__ */ import_react3.default.createElement("div", null, "Not initalized...");
    }
...
var CoreGUI = class {
  ...
  constructor(container) {
    ...
    this.componentRef = (0, import_react3.createRef)();
    this.componentElement = (0, import_react3.createElement)(CoreComponent, { ref: this.componentRef });
...
async function initGUI() {
  ...
  const HookNode = import_react3.default.createElement("div", {
    id: UI_ID
  }, "");
...
var servers = [];
var player;
var FRAME_TIME_MAX = 16.66666666;
